...
class UnittestLyNote(TestCaseWithHelpers.TestCaseWithHelpers):
    ...
    def checkLyResult(self, expNote, lyn):
        ...
        self.assertEqual(note, lyn.note, 'note not equal "%s", expected: "%s", got: "%s"' %
                         (lyn.originalInput, note, lyn.note))
        self.assertEqual(elevation, lyn.elevation, 'elevation not equal "%s", expected: "%s", got: "%s"' %
                         (lyn.originalInput, elevation, lyn.elevation))
        self.assertEqual(duration, lyn.duration, 'duration not equal "%s", expected: "%s", got: "%s"' %
                         (lyn.originalInput, duration, lyn.duration))
        self.assertEqual(additions, lyn.additions, 'additions not equal "%s", expected: "%s", got: "%s"' %
                         (lyn.originalInput, additions, lyn.additions))
        self.assertEqual(backslashed, lyn.backslashed, 'backslashed not equal "%s", expected: "%s", got: "%s"' %
                         (lyn.originalInput, backslashed, lyn.backslashed))
