...
class TestCaseWithHelpers(unittest.TestCase):
    ...
    def assert_equal_dispatch_according_to_type(self, expected, got, mess, epsilon):
        self.assertTrue(self.isnumber(epsilon), "assert_equal called with a value of epsilon that was not a number. Type of epsilon was: %s, value was %s" % (
            self.what_class(epsilon), epsilon))
...
def assert_equal_dispatch_according_to_type(expected, got, mess, epsilon):
    assert isnumber(epsilon), "assert_equal called with a value of epsilon that was not a number. Type of epsilon was: %s, value was %s" % (
        what_class(epsilon), epsilon)
