...
class UnittestMonitorfunctions(TestCaseWithHelpers.TestCaseWithHelpers):
    ...
    def test_adjust_coordinates_side_corners(self):
        ...
        funcStretch([10, 20, 790, 580], -50, 6, 'leftbottom', [-40, 20, 790, 586],
                    "stretching (larger) to the left of leftbottom")
        funcStretch([10, 20, 790, 580], -5, -60, 'leftbottom', [5, 20, 790, 520],
                    "stretching (larger) up instead of to leftbottom")

        # making size minimal:
        funcStretch([10, 20, 790, 580], 1000, 0, 'lefttop', [690, 20, 790, 580],
                    "resizing too much left side, using min_size[0]")
        funcStretch([10, 20, 790, 580], 0, 700, 'lefttop', [10, 510, 790, 580], "resizing too much top, using min_size[1]")
        funcStretch([10, 20, 790, 580], -1000, 0, 'rightbottom', [10, 20, 110, 580],
                    "resizing too much right side, using min_size[0]")
        funcStretch([10, 20, 790, 580], 0, -700, 'rightbottom', [10, 20, 790, 90],
                    "resizing too much bottom, using min_size[1]")
        # combined:
        funcStretch([10, 20, 790, 580], -1000, 700, 'righttop', [10, 510, 110, 580],
                    "resizing too much righttop, using min_size")
        funcStretch([10, 20, 790, 580], 1000, -700, 'leftbottom', [690, 20, 790, 90],
                    "resizing too much leftbottom, using min_size")
        ...
        funcShrink([10, 20, 790, 580], -1000, 700, 'righttop', [10, 510, 110, 580],
                   "resizing too much righttop, using min_size")
        funcShrink([10, 20, 790, 580], 1000, -700, 'leftbottom', [690, 20, 790, 90],
                   "resizing too much leftbottom, using min_size")

        # shrinking with automatic direcion to keeping min_size:
        funcShrink([10, 20, 790, 580], -1000, 700, None, [10, 510, 110, 580],
                   "shrinking too much direction None, using min_size")
        funcShrink([10, 20, 790, 580], 1000, -700, None, [690, 20, 790, 90],
                   "shrinking too much direction None, using min_size")
        funcShrink([10, 20, 790, 580], 1000, 700, None, [690, 510, 790, 580],
                   "shrinking too much direction None, using min_size")
        funcShrink([10, 20, 790, 580], -1000, -700, None, [10, 20, 110, 90],
                   "shrinking too much direction None, using min_size")
