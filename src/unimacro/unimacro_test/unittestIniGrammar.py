...
class UnittestIniGrammar(TestCaseWithHelpers.TestCaseWithHelpers):
    ...
    def xxxtestCalculatorNld(self):
        ...
        fullResults = [('bereken', 'calculation'), ('drie', '__0to9'), ('plus', 'operator'),
                       ('vijf', '__0to9'), ('is gelijk aan', 'calculation')]
        words = ['bereken', 'drie', 'plus', 'vijf', 'is gelijk aan']
        words = ['reken uit', 'drie', 'keer', 'min', 'vier', 'is gelijk aan']
        seqsAndRules = [(['reken uit'], 'calcnormal'), (['drie'], '__0to9'), (['keer', 'min'],
                                                                              'operator'), (['vier'], '__0to9'), (['is gelijk aan'], 'calcnormal')]
        fullResults = [('reken uit', 'calcnormal'), ('drie', '__0to9'), ('keer', 'operator'),
                       ('min', 'operator'), ('vier', '__0to9'), ('is gelijk aan', 'calcnormal')]
...
'''
        ...
        gotIniSpec = testGram.ini.toDict()
        self.assert_equal(expIniSpec, gotIniSpec,
                          "non translated grammar with obsolete words does not produce expected ini file")
